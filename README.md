...
RUN /bin/bash -c '. /opt/ros/noetic/setup.bash; cd /root/miapr ; catkin_make'
# RUN source /opt/ros/noetic/setup.bash && source /root/miapr/devel/setup.bash
RUN pip install pyswarm
RUN echo "export TURTLEBOT3_MODEL=burger" >> /ros_entrypoint.sh
