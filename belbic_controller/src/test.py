from belbic import TurtleBotNode
...
class TEST:
    ...
    def test_points(self, pid):
        ...
        t0 = perf_counter()
        self.turtlebot.calculations(self.destination, pid)
        t1 = perf_counter()
    ...
    # Zapisanie wyników
    def save_error(self):
        file_name = "/home/jakub/ROS_Projects/Turtle_bot_pid/output_belbic/error_"+self.test_type+"_"+self.type+".txt"
        with open(file_name, 'a') as fp:
            fp.write(self.string_tmp)

    # Zapisanie wyników dla poszczegolnych kroków w teście trajektorii
    def save_result(self):
        file_name = "/home/jakub/ROS_Projects/Turtle_bot_pid/output_belbic/results_"+ self.type + ".txt"
        with open(file_name, 'a') as fp:
